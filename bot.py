...
📋 /new_project - создать новый проект
   - Укажите название, ссылку и статус проекта
   
📂 /projects - посмотреть все ваши проекты
   - Показывает список всех проектов с ссылками
   - Нажмите на название проекта для подробной информации

🔧 /skills - добавить навыки к проекту
   - Выберите проект и добавьте соответствующие навыки

✏️ /update_projects - изменить информацию о проекте
   - Можно изменить: название, описание, ссылку, статус

🗑️ /delete - удалить проект
   - Выберите проект из списка для удаления

ℹ️ /info - показать это сообщение справки

Также вы можете:
- Просто ввести название проекта в чат, чтобы посмотреть о нем информацию
- Использовать кнопку "Отмена 🚫" для отмены текущего действия
